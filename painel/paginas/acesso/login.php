    ...
    <div class="login-box">
        ...
        <div class="card card-outline card-primary">
            ...
            <div class="card-body">
                ...
                <form action="?pg=dashboard.php" method="post">
                    <div class="input-group mb-3">
                        <input name type="#" class="form-control" placeholder="Email">
                ...
                <p class="mb-0">
                    <a href="register.html" class="text-center">Fazer novo registro</a>
                </p>
            </div>
            <!-- /.card-body -->
        </div>
